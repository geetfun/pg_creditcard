...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-11-16}
  s.description = %q{Dependency library that handles Ruby Psigate credit card objects}
  ...
  s.summary = %q{Dependency library that handles Ruby Psigate credit card objects}
  s.test_files = [
    "test/helper.rb",
    "test/test_pg_creditcard.rb"
  ]
